...
public class ExplorePlatformThread extends Thread {
    ...
    static void main() {
        ...
        ExplorePlatformThread exploreThread = new ExplorePlatformThread();
        exploreThread.start();
        ...
        platformThread2.start(() -> ExplorePlatformThread.doSomething());
